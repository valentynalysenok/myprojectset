...
class UserTests(TestCase):
    def setUp(self):
        self.u1 = User.objects.create_user(
            'myprojectset@mail.com', 'John Doe', 'myprojectset')
        self.u2 = User.objects.create_superuser(
            'demo2@mail.com', 'Annie Lennox', 'myprojectset')
        self.u3 = User.objects.create_user(
            'robert.downey@mail.com', 'Leslie JJ Mills', 'myprojectset')
        self.u3.save()
    ...
    def test_create_user(self):
        u = User.objects.get(email='myprojectset@mail.com')
